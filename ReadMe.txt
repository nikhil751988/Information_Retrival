...
Each Sub Project's purpose is as follows:
	...
	This module parses the documents and builds a plain index structure which is of the dictionary 
	form containing a mapping of a word to its frequency. Rules for parsing is defined 
	in each tag class and top frequency words along with other pertinent details are displayed.
	...
	In this module, a set of pre-defined queries are provided which are parsed and by applying 
